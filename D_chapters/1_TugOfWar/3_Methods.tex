...
To justify the choice of relevant forces in mass-spring model, we used the relevant literature values to estimate forces generated in this system and applied to capsid proteins (Appendix \ref{appendix:nanomolecular}). As a result, in this model we focus on capsid stiffness and forces generated in Tug-of-War between molecular motors.
