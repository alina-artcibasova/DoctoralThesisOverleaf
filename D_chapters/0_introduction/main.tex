...
Meanwhile, attempts to introduce additional knowledge of underlying intracellular processes often end up with models which still struggle to describe other experimental conditions, but also rely on many unobserved quantities and variables.
