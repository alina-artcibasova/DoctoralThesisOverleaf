...
% Languages
\usepackage[main=english,ngerman,russian]{babel}
...
% Meta
\input{A_preamble/meta}

% Hyphenation
\input{A_preamble/hyphenation}
...
\setlength{\textwidth}{426pt} % 14 pt font
% value from https://www.overleaf.com/learn/latex/page_size_and_margins
...
% CV
\newcommand{\cvleft}[1]{\begin{minipage}[t]{3cm}\begin{flushright}#1\end{flushright}\end{minipage}\hspace{5mm}}
\newcommand{\cvright}[1]{\begin{minipage}[t]{10cm}{#1}\end{minipage}}
